...
/**
 * Название уже набранной целиком команды, если сразу за ней идёт пробел —
 * дальше её аргумент. В отличие от [argumentQuery] не привязана к конкретному
 * набору команд с перечислимыми значениями: годится для любого имени, включая
 * дефисы и "плагин:команда".
 */
