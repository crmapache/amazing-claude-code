...
/**
 * Цвета групп — 40 штук, но не просто оттенок по кругу: два соседних оттенка
 * при одной яркости/насыщенности на глаз почти не отличаются (первая попытка
 * именно так и вышла — золотой угол между оттенками расшатывает соседство, а
 * чередование из трёх поясов яркости/насыщенности разводит по контрасту даже
 * те пары оттенков, что всё равно оказались рядом на круге.
 */
const GROUP_COLOR_COUNT = 40
