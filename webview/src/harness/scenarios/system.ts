...
export const scenariosSystem: Scenario[] = [
  ...
  scenario('context-compaction', 'Сжатие контекста', 'system', [
    ...
    // Пауза долгая нарочно: сжатие в жизни занимает десятки секунд, и полоса
    // прогресса на карточке считается от секундомера. За полторы секунды она не
    // сдвинулась бы вовсе, и смотреть на этом шаге было бы не на что.
