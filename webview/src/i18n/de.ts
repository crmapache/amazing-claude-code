...
export const de: Dict = {
  ...
  scenarios: {
    ...
    button: 'Szenarien',
    untested: {
      text: 'Szenarien sind hier neu und noch nicht von allen Seiten erprobt. Wenn etwas schiefgeht, beschreiben Sie es im Feedback-Formular - nur so lässt es sich beheben.',
    ...
    play: 'Starten',
    when: {
      set: 'Zu einer Uhrzeit starten',
      change: 'Uhrzeit ändern',
      clear: 'Nicht mehr von selbst starten',
      at: 'Um',
      hours: 'Stunde',
      minutes: 'Minuten',
      repeat: 'Wiederholung',
      ...
      ran: (when: string): string => `lief ${when}`,
    ...
    busy: 'In diesem Projekt läuft bereits ein Lauf',
    ...
    shelves: {
      ...
      projectEmpty: 'Hier ist noch nichts. Ein Szenario an dieser Stelle reist mit dem Repository, neben den Befehlen und Skills des Projekts.',
      noProject: 'Dieses Fenster hat keinen Projektordner, also gibt es keinen Platz für ein geteiltes Szenario.',
      userEmpty: 'Hier ist noch nichts. Ein Szenario an dieser Stelle gehört nur dir und begleitet dich von Projekt zu Projekt.',
    },
    runStates: {
      starting: 'Startet',
      running: 'Läuft',
    ...
    outcomes: {
      ...
      scenarioBusy: 'In diesem Projekt läuft bereits ein Lauf. Immer nur einer - zwei würden dieselben Dateien ändern.',
    ...
    editor: {
      ...
      name: 'NAME',
      shelf: 'LIEGT IN',
      inRepository: 'In diesem Repository',
      mine: 'In jedem Projekt',
      head: 'HAUPTSTRANG',
      ...
      questionHead: 'Der Hauptstrang beantwortet sie',
      questionStop: 'Anhalten und auf mich warten',
      retries: 'ZURÜCKSCHICKEN',
      noRetries: 'Ein Versuch, keine zweite Chance',
      retriesCount: (n) => (n === 1 ? 'höchstens einmal' : `höchstens ${n}-mal`),
      inputs: 'WIRD VOR DEM START GEFRAGT',
      ...
      slots: 'FELDER, DIE DER HAUPTSTRANG FÜLLT',
  ...
  mobile: {
    ...
    scenarios: {
      ...
      none: 'In diesem Projekt ist noch kein Arbeitsablauf aufgeschrieben.',
      deskNote: 'Szenarien werden am Schreibtisch geschrieben, gestartet und zeitlich geplant. Von hier aus kannst du einen Lauf verfolgen, seine Fragen beantworten und ihn stoppen.',
    },
