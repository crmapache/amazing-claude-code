...
export const de: Dict = {
  ...
  feed: {
    ...
    workflow: {
      ...
      steps: 'WAS ES GETAN HAT',
      returned: 'WAS ES ZURÜCKGAB',
      cut: 'Abgeschnitten - die Antwort geht über das hinaus, was hier Platz hat.',
      noTranscript: 'Sein Protokoll liegt nicht mehr auf der Platte - das hier ist der Auszug aus dem Bericht.',
      reading: 'Protokoll wird gelesen…',
    },
    ...
    tool: {
      ...
      closed: {
        ...
        restarted: 'Claude Code wurde hier neu gestartet, und das hier hat es nicht überlebt.',
      },
      closedMeta: {
        ...
        restarted: '· beim Neustart verloren',
      },
    },
    ...
    task: {
      ...
      closed: {
        ...
        restarted: 'Claude Code wurde hier neu gestartet, und dieser Agent hat es nicht überlebt.',
      },
    },
    ...
    result: {
      ...
      restarted: 'Claude Code neu gestartet - alles, was noch lief, wurde abgebrochen',
    },
  ...
  mobile: {
    ...
    sessions: {
      ...
      openAndStart: 'Öffnen und starten',
      waitingForYou: 'Wartet auf dich',
      answer: 'Antworten',
      countWaiting: (n) => `${n} warten`,
      countOpen: (n) => `${n} offen`,
      kind: {
      ...
      state: {
        crashed: 'gestoppt - der Prozess ist gestorben',
        waiting: 'wartet auf dich',
        waitingPermission: 'wartet auf dich · Erlaubnis',
        waitingQuestion: 'wartet auf dich · Frage',
        waitingPlan: 'wartet auf dich · Plan',
        working: 'arbeitet',
        done: 'fertig',
      },
      reach: {
    ...
    thread: {
      ...
      stopAgent: (what) => `${what} stoppen?`,
    },

    drawer: {
      menu: 'Menü',
      projects: 'Projekte',
      tasks: 'Aufgaben und Agenten',
      mcp: 'MCP-Server',
      plugins: 'Plugins',
      accounts: 'Claude-Konten',
      pair: 'Eine IDE koppeln',
      forget: 'Vergessen',
      waiting: (n) => `${n} warten`,
      live: (n) => `${n} aktiv`,
      sealed: 'Versiegelt zwischen deiner IDE und diesem Telefon.',
    },
    ...
    tasks: {
      title: 'Aufgaben und Agenten',
      label: 'Aufgabenliste',
      doneOf: (done, total) => `${done} von ${total} erledigt`,
      running: 'LÄUFT',
      agents: 'Agenten',
      agent: 'Subagent',
      background: 'Im Hintergrund',
      nothing: 'In diesem Gespräch läuft nichts.',
      agentGone: 'Diesen Agenten gibt es im Gespräch auf dem Bildschirm nicht mehr.',
    },

    run: {
      title: 'Wie dieser Zug läuft',
      subtitle: 'gilt nur für dieses Gespräch',
      apply: 'Übernehmen',
      locked: 'gesperrt',
      inForce: 'gilt gerade',
      modeNote: 'Dieses Gespräch wurde am Schreibtisch begonnen, und davor sitzt vielleicht jemand - deshalb ist sein Berechtigungsmodus von hier aus nicht erreichbar. Ein Gespräch, das du vom Telefon startest, beginnt in jedem Modus, den du wählst.',
    },

    message: {
      title: 'Diese Nachricht',
      quote: 'In meine nächste Nachricht zitieren',
      fork: 'Von hier abzweigen',
      forkHint: 'Ein neues Gespräch mit allem bis zu dieser Stelle.',
      copy: 'Kopieren',
      pin: 'Über dem Verlauf anheften',
      unpin: 'Lösen',
      pinsFull: 'Drei sind schon angeheftet - löse zuerst eine.',
    },
    ...
    plugins: {
      ...
      readOnly: 'Ein Plugin zu installieren oder abzuschalten bleibt am Schreibtisch - beides führt fremden Code auf jener Maschine aus. Hier geht es darum zu sehen, welche Skills und Befehle ein Gespräch tatsächlich hat.',
      noneInstalled: 'Keine Plugins installiert.',
      nothingFound: 'Nichts gefunden.',
      noMarkets: 'Keine Quellen verbunden.',
      search: 'Katalog durchsuchen',
      on: 'an',
      off: 'aus',
      trimmed: 'Der Katalog ist auf das gekürzt, was in eine Nachricht passt - der Rest steht am Schreibtisch.',
    },

    accounts: {
      subtitle: 'welches Abo die Arbeit bezahlt',
      paying: 'Bezahlt dieses Gespräch',
      none: 'Nur die Anmeldung, die Claude Code schon hatte.',
      switchAsk: (name) => `Ab jetzt auf ${name} arbeiten? Alle offenen Gespräche auf jener Maschine ziehen darauf um, und ein laufender Zug wird abgebrochen.`,
      switchNote: 'Ein Kontowechsel zieht alle offenen Gespräche jener Maschine auf das neue Konto um und bricht einen laufenden Zug ab.',
      addNote: 'Ein Konto hinzuzufügen und Claude Design zu autorisieren bleiben am Schreibtisch: beides öffnet dort ein Terminal und eine Browser-Anmeldung.',
      forgetAsk: (name) => `${name} vergessen? Die Anmeldedaten werden von jener Maschine entfernt - das Konto selbst bleibt unberührt, erneutes Anmelden holt es zurück.`,
      logoutAsk: 'Von Claude Code abmelden? Das widerruft die Anmeldedaten bei Anthropic - auf allen deinen Maschinen.',
    },
    ...
    composer: {
      ...
      queue: 'Anstellen',
      running: 'läuft',
      queued: (n) => `${n} in der Warteschlange`,
      dropQuote: 'Zitat entfernen',
