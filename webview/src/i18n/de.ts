...
export const de: Dict = {
  ...
  thanks: {
    ...
    shareText:
      'Schau dir Amazing Claude Code an - Claude Code als ordentliches Panel direkt in JetBrains-IDEs: https://plugins.jetbrains.com/plugin/33255-amazing-claude-code',
  },
