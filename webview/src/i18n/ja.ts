...
export const ja: Dict = {
  ...
  scenarios: {
    ...
    button: 'シナリオ',
    untested: {
      text: 'シナリオはまだ新しく、あらゆる場面で試せてはいません。うまく動かないことがあれば、フィードバックのフォームに書いてください。そうすれば直せます。',
      report: '問題を報告',
    },
    create: '新しいシナリオ',
    newName: '新しいシナリオ',
    ...
    draft: {
      title: '新しいシナリオ',
      hint: '一連の作業を説明すると、Claude が書き留めます。何を、どの順番で行い、最後に何が成り立っていればよいか。',
    ...
    when: {
      ...
      ran: (when: string): string => `${when} に実行`,
    ...
    shelves: {
      project: 'このリポジトリの中',
      user: 'すべてのプロジェクトで',
      projectEmpty: 'まだ何もありません。ここに置いたシナリオはリポジトリと一緒に移動し、プロジェクト自身のコマンドやスキルの隣に並びます。',
      noProject: 'このウィンドウにはプロジェクトフォルダがないので、共有するシナリオの置き場所がありません。',
      userEmpty: 'まだ何もありません。ここに置いたシナリオはあなただけのもので、プロジェクトを移っても付いてきます。',
    },
    runStates: {
      starting: '起動中',
      running: '進行中',
    ...
    outcomes: {
      ...
      scenarioBusy: 'このプロジェクトではすでに実行が進行中です。一度に一つだけ - 二つあると同じファイルを書き換えてしまいます。',
    ...
    editor: {
      ...
      onQuestion: '質問されたら',
      questionHead: 'メインスレッドが答える',
      questionStop: '止まって私を待つ',
      retries: 'やり直させる',
      noRetries: '一度きり、やり直しなし',
      retriesCount: (n) => `最大 ${n} 回`,
      inputs: '開始前に尋ねること',
      addInput: '質問を追加',
  ...
  mobile: {
    ...
    scenarios: {
      running: '実行中',
      nothingRunning: 'このプロジェクトでは今のところ何も実行されていません。',
      none: 'このプロジェクトには一連の作業がまだ書かれていません。',
      deskNote: 'シナリオの作成、開始、時刻の設定はデスクで行います。ここからは実行の様子を見て、質問に答え、止めることができます。',
    },
