...
export const ja: Dict = {
  ...
  feed: {
    ...
    pin: {
      add: 'チャットの上部にピン留めする',
      crowded: '最大3件です - どれか1件のピン留めを外してから、これを留めてください',
      remove: 'ピン留めを外す',
    },
    ...
    workflow: {
      ...
      steps: '実行した操作',
      returned: '返した内容',
      cut: 'ここで切りました - 回答はこの先も続きます。',
      noTranscript: 'この記録はディスクに残っていません - これはレポートの抜粋です。',
      reading: '記録を読み込んでいます…',
    },
    ...
    tool: {
      ...
      closed: {
        ...
        restarted: 'ここで Claude Code が再起動し、これは残りませんでした。',
      },
      closedMeta: {
        replay: '· 記録になし',
        exited: '· 中断',
    ...
    task: {
      ...
      closed: {
        ...
        restarted: 'ここで Claude Code が再起動し、このエージェントは残りませんでした。',
      },
    },
    ...
    result: {
      ...
      restarted: 'Claude Code が再起動しました - 動いていたものはすべて打ち切られました',
    },
  ...
  mobile: {
    ...
    sessions: {
      ...
      state: {
        crashed: '停止 - プロセスが落ちた',
        waiting: 'あなた待ち',
        waitingPermission: 'あなた待ち · 許可',
        waitingQuestion: 'あなた待ち · 質問',
        waitingPlan: 'あなた待ち · 計画',
        working: '作業中',
        done: '完了',
      },
      reach: {
    ...
    drawer: {
      ...
      waiting: (n) => `${n} 件待ち`,
      live: (n) => `${n} 件実行中`,
      sealed: 'あなたの IDE とこの端末のあいだで封をしています。',
    },
    ...
    tasks: {
      title: 'タスクとエージェント',
      label: 'タスクリスト',
      doneOf: (done, total) => `${total} 件中 ${done} 件完了`,
      running: '実行中',
      agents: 'エージェント',
      agent: 'サブエージェント',
      background: 'バックグラウンド',
      nothing: 'この会話では何も動いていません。',
      agentGone: 'このエージェントは画面の会話にもう存在しません。',
    },

    run: {
      title: 'このターンの走らせ方',
      subtitle: 'この会話にだけ効きます',
      apply: '適用',
      locked: 'ロック中',
      inForce: '現在有効',
      modeNote: 'この会話は机の上で始まったもので、誰かがその前に座っているかもしれません。だから権限モードはここからは触れません。端末から始めた会話なら、好きなモードで始められます。',
    },
    ...
    message: {
      ...
      quote: '次のメッセージに引用する',
      fork: 'ここからフォーク',
      forkHint: 'ここまでの全部を引き継いだ新しい会話。',
      copy: 'コピー',
      pin: '会話の上に固定',
      unpin: '固定を外す',
      pinsFull: 'すでに 3 件固定されています。まず 1 件外してください。',
    },
    ...
    plugins: {
      ...
      readOnly: 'プラグインの導入と無効化は机の上のままです。どちらもそのマシンで他人のコードを走らせます。ここで役に立つのは、会話が実際にどのスキルとコマンドを持っているかを見ることです。',
      noneInstalled: 'プラグインは入っていません。',
      nothingFound: '一致するものがありません。',
      noMarkets: '提供元がつながっていません。',
      search: 'カタログを検索',
      on: 'オン',
      off: 'オフ',
      trimmed: 'カタログは 1 通のメッセージに収まる分だけです。残りは机の上にあります。',
    },

    accounts: {
      subtitle: 'どのサブスクリプションが支払っているか',
      paying: 'この会話の支払い元',
      none: 'Claude Code がもともと持っていたサインインだけです。',
      switchAsk: (name) => `これから ${name} で作業しますか？そのマシンの開いている会話はすべて移り、進行中のターンは中断されます。`,
      switchNote: 'アカウントを切り替えると、そのマシンの開いている会話はすべて新しいアカウントに移り、進行中のターンは中断されます。',
      addNote: 'アカウントの追加と Claude Design の認可は机の上のままです。どちらもそのマシンでターミナルとブラウザのサインインを開きます。',
      forgetAsk: (name) => `${name} を削除しますか？資格情報はそのマシンから消えます。アカウント自体はそのままで、入り直せば戻ります。`,
      logoutAsk: 'Claude Code からサインアウトしますか？Anthropic 側で資格情報が失効し、すべての端末でサインアウトされます。',
    },
