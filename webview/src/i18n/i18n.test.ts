...
const SHARED_WITH_ENGLISH: Record<string, Locale[]> = {
  ...
  'mobile.sessions.kind.question': ['fr'],
  'mobile.sessions.kind.plan': ['es', 'de', 'fr'],
  'mobile.drawer.menu': ['pt-BR', 'fr'],
  'mobile.drawer.plugins': ['pt-BR', 'de'],
  'mobile.tabs.title': ['fr'],
  'mobile.tasks.agent': ['de'],
  'mobile.tasks.agents': ['fr'],
