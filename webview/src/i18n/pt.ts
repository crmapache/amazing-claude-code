...
export const pt: Dict = {
  ...
  scenarios: {
    ...
    button: 'Cenários',
    untested: {
      text: 'Os cenários são novos aqui e ainda não foram testados por todos os lados. Se algo der errado, descreva no formulário de feedback: é assim que dá para corrigir.',
    ...
    draft: {
      ...
      write: 'Deixe o Claude escrever',
      byHand: 'Eu mesmo monto',
      going: 'Lendo o projeto e escrevendo\u2026',
    },
    play: 'Executar',
    when: {
      set: 'Iniciar num horário',
      change: 'Mudar o horário',
      clear: 'Parar de iniciar sozinho',
      at: 'Às',
      hours: 'Hora',
      minutes: 'Minutos',
      repeat: 'Repetir',
      ...
      ran: (when: string): string => `rodou ${when}`,
    ...
    busy: 'Já existe uma execução em andamento neste projeto',
    ...
    shelves: {
      ...
      projectEmpty: 'Ainda não há nada aqui. Um cenário guardado aqui viaja com o repositório, ao lado dos comandos e das skills do projeto.',
      noProject: 'Esta janela não tem pasta de projeto, então não há onde guardar um cenário compartilhado.',
      userEmpty: 'Ainda não há nada aqui. Um cenário guardado aqui é só seu e acompanha você de projeto em projeto.',
    },
    runStates: {
      starting: 'Iniciando',
    ...
    outcomes: {
      ...
      scenarioBusy: 'Já existe uma execução em andamento neste projeto. Uma de cada vez - duas mexeriam nos mesmos arquivos.',
    ...
    editor: {
      ...
      name: 'NOME',
      shelf: 'GUARDADO EM',
      inRepository: 'Neste repositório',
      mine: 'Em todos os projetos',
      head: 'THREAD PRINCIPAL',
      ...
      questionHead: 'A thread principal responde',
      questionStop: 'Parar e esperar por mim',
      retries: 'DEVOLVER',
      noRetries: 'Uma tentativa, sem segunda chance',
      retriesCount: (n) => (n === 1 ? 'no máximo uma vez' : `no máximo ${n} vezes`),
      inputs: 'PERGUNTADO ANTES DE COMEÇAR',
      ...
      slots: 'ESPAÇOS QUE A THREAD PRINCIPAL PREENCHE',
  ...
  mobile: {
    ...
    scenarios: {
      running: 'EM ANDAMENTO',
      nothingRunning: 'Nada está em andamento neste projeto agora.',
      none: 'Nenhuma rotina de trabalho foi escrita neste projeto.',
      deskNote: 'Os cenários são escritos, iniciados e agendados no computador. Daqui você pode acompanhar uma execução, responder ao que ela pergunta e pará-la.',
    },
