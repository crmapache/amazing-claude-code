...
export const ko: Dict = {
  ...
  scenarios: {
    ...
    button: '시나리오',
    untested: {
      text: '시나리오는 아직 새로 들어온 기능이라 모든 상황에서 검증되지는 않았습니다. 문제가 생기면 피드백 양식에 적어 주세요. 그래야 고칠 수 있습니다.',
      report: '문제 신고',
    },
    create: '새 시나리오',
    newName: '새 시나리오',
    ...
    draft: {
      title: '새 시나리오',
      hint: '작업 흐름을 설명하면 Claude가 받아 적습니다. 무엇을, 어떤 순서로 하고, 끝에 무엇이 참이어야 하는지.',
      write: 'Claude에게 맡기기',
      byHand: '직접 만들기',
      going: '프로젝트를 읽고 쓰는 중\u2026',
    },
    ...
    when: {
      ...
      ran: (when: string): string => `${when} 실행됨`,
    ...
    shelves: {
      project: '이 저장소 안',
      user: '모든 프로젝트에서',
      projectEmpty: '아직 아무것도 없습니다. 여기에 둔 시나리오는 저장소와 함께 이동하며, 프로젝트의 명령과 스킬 옆에 놓입니다.',
      noProject: '이 창에는 프로젝트 폴더가 없어서 공유할 시나리오를 둘 곳이 없습니다.',
      userEmpty: '아직 아무것도 없습니다. 여기에 둔 시나리오는 나만의 것이며 프로젝트를 옮겨도 따라옵니다.',
    },
    runStates: {
      starting: '시작하는 중',
      running: '진행 중',
    ...
    outcomes: {
      ...
      scenarioBusy: '이 프로젝트에서는 이미 실행이 진행 중입니다. 한 번에 하나씩 - 둘이면 같은 파일을 함께 고치게 됩니다.',
    ...
    editor: {
      ...
      warnings: '정리해 두면 좋은 것:',
      name: '이름',
      shelf: '보관 위치',
      inRepository: '이 저장소 안',
      mine: '모든 프로젝트에서',
      head: '메인 스레드',
      ...
      onQuestion: '질문이 오면',
      questionHead: '메인 스레드가 답한다',
      questionStop: '멈추고 나를 기다린다',
      retries: '다시 시키기',
      noRetries: '한 번뿐, 두 번째 기회 없음',
      retriesCount: (n) => `최대 ${n}번`,
      inputs: '시작 전에 묻는 것',
      addInput: '질문 추가',
  ...
  mobile: {
    ...
    scenarios: {
      running: '실행 중',
      nothingRunning: '지금 이 프로젝트에서 실행 중인 것이 없습니다.',
      none: '이 프로젝트에는 아직 작성된 작업 흐름이 없습니다.',
      deskNote: '시나리오는 데스크에서 작성하고 시작하고 시간을 정합니다. 여기서는 실행을 지켜보고, 질문에 답하고, 멈출 수 있습니다.',
    },
