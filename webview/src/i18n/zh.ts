...
export const zh: Dict = {
  ...
  scenarios: {
    ...
    button: '场景',
    untested: {
      text: '场景是刚加进来的，还没有从各个角度试过。如果出了问题，请在反馈表单里写清楚 - 这样才修得了。',
      report: '报告问题',
    },
    create: '新建场景',
    newName: '新场景',
    ...
    draft: {
      title: '新建场景',
      hint: '描述这轮工作，Claude 来写下来：做什么、按什么顺序、结束时什么必须成立。',
      write: '让 Claude 来写',
      byHand: '我自己搭',
      going: '正在读项目并撰写\u2026',
    },
    ...
    when: {
      ...
      ran: (when: string): string => `${when} 已运行`,
    ...
    shelves: {
      project: '在这个仓库里',
      user: '在所有项目里',
      projectEmpty: '这里还什么都没有。放在这里的场景会随仓库一起走，和项目自己的命令与技能放在一起。',
      noProject: '这个窗口没有项目文件夹，所以没有地方放共享的场景。',
      userEmpty: '这里还什么都没有。放在这里的场景只属于你，会跟着你从一个项目到另一个项目。',
    },
    runStates: {
      starting: '正在启动',
      running: '进行中',
    ...
    outcomes: {
      ...
      scenarioBusy: '这个项目里已经有一次运行在进行。一次只能一个 - 两个会改同样的文件。',
    ...
    editor: {
      ...
      questionStop: '停下来等我',
      retries: '退回重做',
      noRetries: '只有一次机会，不给第二次',
      retriesCount: (n) => `最多 ${n} 次`,
      inputs: '开始前会问的',
      addInput: '添加一个问题',
  ...
  mobile: {
    ...
    scenarios: {
      running: '正在运行',
      nothingRunning: '此项目当前没有正在运行的场景。',
      none: '此项目还没有记录任何工作流程。',
      deskNote: '场景的编写、启动和定时都在电脑前完成。在这里可以查看运行情况、回答它的提问并将其停止。',
    },
