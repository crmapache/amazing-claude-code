...
export const uk: Dict = {
  ...
  pasteCollapse: {
    note: 'Багаторядкова вставка згортається в чип, щоб стіна тексту не заповнювала поле введення. Нічого при цьому не втрачається - згорнута вставка зберігає текст цілком і розгортається назад у поле кнопкою з олівцем на ній.',
  ...
  voice: {
    ...
    enableHint: 'Показує кнопку мікрофона і слухає гарячі клавіші нижче.',
    ...
    getKeyHint: 'Зареєструйтеся на deepgram.com і створіть API-ключ. Новим акаунтам дають $200 без прив’язки картки - за нинішніми цінами це кілька сотень годин диктування.',
    openSite: 'Відкрити deepgram.com',

    hotkeys: 'ГАРЯЧІ КЛАВІШІ',
    hotkeysHint: 'Працюють, поки клавіатура в IDE - у редакторі, у панелі, у діалозі. В іншій програмі не спрацюють.',
    ...
    modifierTip: 'Одиночний модифікатор тут найзручніший: затисніть правий Option або правий Ctrl - за них в IDE ніхто не сперечається.',
  ...
  chrome: {
    ...
    confirm: { cancel: 'Скасувати', stop: 'Зупинити', open: 'Відкрити' },
    resume: { title: 'У цій вкладці триває робота. Відкрити минулий чат тут?' },
    noChats: { title: 'Відкритих чатів немає', button: 'Новий чат' },
    crash: {
