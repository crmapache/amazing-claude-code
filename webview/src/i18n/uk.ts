...
export const uk: Dict = {
  ...
  menu: {
    titles: {
      ...
      appearance: { title: 'ВИГЛЯД', hint: 'тема й розмір тексту' },
      ...
      indicators: { title: 'ІНДИКАТОРИ', hint: 'що лишається довкола поля' },
      ...
      restoreTabs: { title: 'ВКЛАДКИ ПІД ЧАС ЗАПУСКУ', hint: 'що повернеться після перезапуску' },
      ...
      settingSources: { title: 'ДЖЕРЕЛА НАЛАШТУВАНЬ', hint: 'які шари читає Claude Code' },
    ...
    rows: {
      ...
      settings: { label: 'Налаштування', sub: 'Тема, звуки, нові чати, мова' },
  ...
  settings: {
    rows: {
      appearance: { label: 'Вигляд', sub: 'Тема й розмір тексту' },
      ...
      indicators: { label: 'Індикатори', sub: 'Які показники видно біля поля' },
      newChat: { label: 'Нові чати', sub: 'Модель, зусилля та режим дозволів' },
      restoreTabs: { label: 'Вкладки під час запуску', sub: 'Відкрити те, що було відкрито, з чернетками' },
      ...
      settingSources: { label: 'Джерела налаштувань', sub: 'Які шари Claude Code читає тут' },
  ...
  appearance: {
    size: 'РОЗМІР ТЕКСТУ',
    theme: 'ТЕМА',
    followConsole: 'Як шрифт консолі',
    followConsoleSub: (size) => `Як шрифт консолі в IDE - зараз ${size}`,
    own: 'Власний розмір',
    ownSub: 'Лише для панелі - редактор, термінал і консоль залишаться як є',
    smaller: 'Менше',
    larger: 'Більше',
    followIde: 'Як в IDE',
    followIdeSub: (theme) => `Як в IDE - зараз ${theme}`,
    dark: 'Темна',
    darkSub: 'Завжди темна, навіть у світлій IDE',
    light: 'Світла',
    lightSub: 'Завжди світла, навіть у темній IDE',
    darkWord: 'темна',
    lightWord: 'світла',
    auto: 'Авто',
  },
  ...
  restoreTabs: {
    label: 'Відновлювати вкладки',
    hint: 'Вкладки, їхні розмови й недописаний текст повернуться, коли проєкт відкриють знову - і після падіння IDE теж',
    note: 'Нічого не запускається заново: агент піднімається, лише коли вкладку відкриють або напишуть у неї. Чернетки зберігаються на цій машині, у теці самої IDE, і більше ніде.',
    on: 'Увімк',
    off: 'Вимк',
  },
  ...
  indicators: {
    contextBar: { label: 'Смужка контексту', hint: 'Смуга над полем, що заповнюється в міру розмови' },
    contextFigure: {
      label: 'Цифра контексту',
      hint: '«ctx 42%» у кінці смуги - лише у звичайному розташуванні; у вузьких цифра живе в підказці смуги',
    },
    fiveHour: { label: 'П’ятигодинний ліміт', hint: 'Кільце п’ятигодинного вікна підписки' },
    week: { label: 'Тижневий ліміт', hint: 'Кільце тижневого вікна підписки' },
    modelWeek: {
      label: 'Тижневий ліміт моделі',
      named: (model) => `Тижневий ліміт ${model}`,
      hint: 'Окремий тиждень моделі, як в особистому кабінеті - видно, лише поки він є в плані',
    },
    tokens: { label: 'Токени за сьогодні', hint: 'Витрачено сьогодні, по всіх проєктах' },
    feedback: { label: 'Кнопка зворотного зв’язку', hint: 'Хмаринка, що відкриває форму - з меню вона відкривається завжди' },
    thanks: { label: 'Сердечко', hint: 'Зірка, відгук або слово другові' },
  },
  ...
  scenarios: {
    ...
    moveRow: 'Перетягнути на інше місце або на іншу полицю',
    delete: 'Видалити',
    ...
    outcomes: {
      ...
      scenarioOnBothShelves: 'На іншій полиці вже є сценарій з тим самим ідентифікатором, тож цей лишився на місці.',
      orderNotWritten: 'Новий порядок полиці не вдалося записати на диск.',
  ...
  settingSources: {
    note: 'Claude Code читає налаштування з кількох файлів, і файли репозиторію сильніші за ваші: блок env, закомічений у нього, задає адресу й ключ, з якими йде кожен запит. Вимкнений шар забирає із собою свої дозволи, хуки та MCP-сервери. Налаштування організації діють у будь-якому разі.',
    all: 'Усі',
    allSub: 'Ваші, репозиторію та його локальний файл - як Claude Code робить сам',
    withoutLocal: 'Без локального файла',
    withoutLocalSub: 'Пропускає settings.local.json, спільні налаштування репозиторію лишаються',
    userOnly: 'Лише мої',
    userOnlySub: 'Пропускає обидва файли репозиторію - вирішують ваш вхід і ваші налаштування',
    repositorySets: 'Репозиторій задає',
    repositoryMeans: 'Поки його шари читаються, це сильніше за обраний тут акаунт і адресу.',
    repositoryQuiet: 'Репозиторій не задає нічого, що перебило б ваш акаунт чи адресу.',
    needsNewer: 'Цей Claude Code не знає потрібного прапорця - шари читаються всі, хоч би що тут стояло. Оновіть його.',
  },
  ...
  feed: {
    ...
    outranked: {
      label: 'НАЛАШТУВАННЯ',
      text: 'Репозиторій перебиває обраний тут акаунт:',
      open: 'Джерела налаштувань',
    },

    sampling: {
      note: 'Нові моделі більше не приймають параметри вибірки, а в цьому запиті такий був. Claude Code своїх не додає - отже, його додає те, через що йдуть запити: зазвичай шлюз або проксі, заданий адресою в налаштуваннях.',
    },
    ...
    ask: {
          ...
          rest >= 11 && rest <= 14
            ...
            : last === 1
              ...
              : last >= 2 && last <= 4
                ? 'питання'
                : 'питань'
        return `${n} ${word} · так і лишилося без відповіді`
      },
      ...
      leftOverNote: 'той хід давно скінчився - відповідь піде звичайним повідомленням',
  ...
  accounts: {
    ...
    outcome: {
      ...
      'already-here': 'Цей акаунт уже є: це вхід самого Claude Code, тож нічого не додано.',
  ...
  mobile: {
    ...
    limits: {
      ...
      modelWindow: (model) => `Тижневе вікно ${model}`,
      paceNote: (percent) =>
  ...
  status: {
    ...
    modelWeekLimit: (model) => `Тижневий ліміт ${model}`,
