...
export const es: Dict = {
  ...
  scenarios: {
    ...
    button: 'Escenarios',
    untested: {
      text: 'Los escenarios son nuevos aquí y todavía no se han probado por todos lados. Si algo sale mal, descríbelo en el formulario de comentarios: solo así se puede arreglar.',
    ...
    draft: {
      ...
      hint: 'Describe la ronda de trabajo y Claude la escribe: qué hacer, en qué orden y qué debe cumplirse al final.',
      write: 'Que lo escriba Claude',
      byHand: 'Lo armo yo',
      going: 'Leyendo el proyecto y escribiéndola\u2026',
    },
    play: 'Ejecutar',
    when: {
      set: 'Iniciar a una hora',
      change: 'Cambiar la hora',
      clear: 'Dejar de iniciarlo solo',
      at: 'A las',
      hours: 'Hora',
      minutes: 'Minutos',
      repeat: 'Repetir',
      ...
      ran: (when: string): string => `se ejecutó ${when}`,
    ...
    busy: 'Ya hay una ejecución en marcha en este proyecto',
    ...
    shelves: {
      ...
      projectEmpty: 'Aquí no hay nada aún. Un escenario puesto aquí viaja con el repositorio, junto a los comandos y las skills del proyecto.',
      noProject: 'Esta ventana no tiene carpeta de proyecto, así que no hay dónde poner un escenario compartido.',
      userEmpty: 'Aquí no hay nada aún. Un escenario puesto aquí es solo tuyo y te acompaña de un proyecto a otro.',
    },
    runStates: {
      starting: 'Arrancando',
      running: 'En marcha',
    ...
    outcomes: {
      ...
      scenarioBusy: 'Ya hay una ejecución en marcha en este proyecto. De una en una: dos tocarían los mismos archivos.',
    ...
    editor: {
      ...
      name: 'NOMBRE',
      shelf: 'GUARDADO EN',
      inRepository: 'En este repositorio',
      mine: 'En todos los proyectos',
      head: 'HILO PRINCIPAL',
      ...
      questionHead: 'La responde el hilo principal',
      questionStop: 'Parar y esperarme',
      retries: 'DEVOLVER',
      noRetries: 'Un intento y sin segundas oportunidades',
      retriesCount: (n) => (n === 1 ? 'una vez como mucho' : `${n} veces como mucho`),
      inputs: 'SE PREGUNTA ANTES DE EMPEZAR',
      ...
      slots: 'HUECOS QUE RELLENA EL HILO PRINCIPAL',
  ...
  mobile: {
    ...
    scenarios: {
      ...
      deskNote: 'Los escenarios se escriben, se lanzan y se programan en el escritorio. Desde aquí puedes seguir una ejecución, responder a lo que pregunta y detenerla.',
    },
