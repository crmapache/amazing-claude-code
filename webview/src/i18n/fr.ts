...
export const fr: Dict = {
  ...
  scenarios: {
    ...
    button: 'Scénarios',
    untested: {
      text: 'Les scénarios sont récents ici et n\'ont pas encore été essayés sous toutes les coutures. Si quelque chose ne va pas, décrivez-le dans le formulaire de retour : c\'est ainsi que cela se corrige.',
    ...
    draft: {
      ...
      hint: "Décris le tour de travail et Claude l'écrit : quoi faire, dans quel ordre et ce qui doit être vrai à la fin.",
      write: "Que Claude l'écrive",
      byHand: 'Le construire moi-même',
      going: 'Lit le projet et écrit\u2026',
    },
    play: 'Lancer',
    when: {
      set: 'Lancer à une heure',
      change: "Changer l'heure",
      clear: 'Ne plus lancer tout seul',
      at: 'À',
      hours: 'Heure',
      minutes: 'Minutes',
      repeat: 'Répétition',
      ...
      ran: (when: string): string => `lancé ${when}`,
    ...
    busy: 'Une exécution est déjà en cours dans ce projet',
    ...
    shelves: {
      ...
      projectEmpty: 'Rien ici pour l\'instant. Un scénario rangé ici voyage avec le dépôt, à côté des commandes et des skills du projet.',
      noProject: 'Cette fenêtre n\'a pas de dossier de projet, il n\'y a donc nulle part où ranger un scénario partagé.',
      userEmpty: 'Rien ici pour l\'instant. Un scénario rangé ici n\'appartient qu\'à vous et vous suit de projet en projet.',
    },
    runStates: {
      starting: 'Démarrage',
      running: 'En cours',
    ...
    outcomes: {
      ...
      scenarioBusy: 'Une exécution est déjà en cours dans ce projet. Une à la fois - deux toucheraient aux mêmes fichiers.',
    ...
    editor: {
      ...
      warnings: 'À remettre au propre :',
      name: 'NOM',
      shelf: 'RANGÉ DANS',
      inRepository: 'Dans ce dépôt',
      mine: 'Dans tous les projets',
      head: 'FIL PRINCIPAL',
      ...
      questionHead: 'Le fil principal y répond',
      questionStop: 'S\'arrêter et m\'attendre',
      retries: 'RENVOYER',
      noRetries: 'Un essai, sans deuxième chance',
      retriesCount: (n) => (n === 1 ? 'une fois au plus' : `${n} fois au plus`),
      inputs: 'DEMANDÉ AVANT DE COMMENCER',
      ...
      slots: 'EMPLACEMENTS QUE LE FIL PRINCIPAL REMPLIT',
  ...
  mobile: {
    ...
    scenarios: {
      running: 'EN COURS',
      nothingRunning: "Rien n'est en cours dans ce projet pour le moment.",
      none: "Aucun cycle de travail n'est écrit dans ce projet.",
      deskNote: "Les scénarios s'écrivent, se lancent et se programment au bureau. D'ici, vous pouvez suivre une exécution, répondre à ses questions et l'arrêter.",
    },
