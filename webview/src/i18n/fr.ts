...
export const fr: Dict = {
  ...
  indicators: {
    ...
    modelWeek: {
      label: 'Limite hebdomadaire d’un modèle',
      named: (model) => `Limite hebdomadaire ${model}`,
      hint: 'La semaine propre d’un modèle, comme sur la page du compte - seulement tant que le forfait en a une',
    },
  ...
  scenarios: {
    ...
    queue: {
      ...
      waitingHere: (n) => (n === 1 ? '1 passage attend dans la file' : `${n} passages attendent dans la file`),
      placeFirst: 'Il passera en premier.',
      placeBehind: (name) => `Il passera en premier et démarrera quand ${name} sera terminé.`,
      place: (ahead) => (ahead === 1 ? 'Il y a 1 passage devant lui.' : `Il y a ${ahead} passages devant lui.`),
      startWhen: 'QUAND LE LANCER',
      afterSuccess: 'Quand le précédent s’est bien terminé',
      afterSuccessNote: 'Si celui-là échoue ou est arrêté, la file s’arrête ici et vous attend.',
      afterAnything: 'Après le précédent, quoi qu’il arrive',
      afterAnythingNote: 'Démarre même si le précédent a échoué. Pour du travail qui n’en dépend pas.',
      waitsForSuccess: 'après un passage réussi',
      waitsForAnything: 'après n’importe quelle fin',
      switchToAny: 'Le lancer même si le précédent échoue',
      switchToSuccess: 'Ne le lancer qu’après un passage réussi',
      wouldNotStart: (why) => `n’a pas démarré : ${why}`,
      moveUp: 'Monter dans la file',
      moveDown: 'Descendre dans la file',
      remove: 'Retirer de la file',
      stopped: 'La file s’est arrêtée',
      stoppedOn: (name, why) => `${name} s’est terminé : ${why}. Rien ne démarrera après.`,
      stoppedUnknown: 'on ne sait pas comment il s’est terminé',
      goOn: 'Lancer le suivant',
      goOnBehind: 'Reprendre après celui en cours',
      goOnBehindHint: (name) => `Le suivant démarrera quand ${name} sera terminé.`,
      clear: 'Vider la file',
      clearTitle: 'Vider la file ?',
      clearSubject: (n) => (n === 1 ? '1 passage en attente' : `${n} passages en attente`),
      goingNow: 'En cours',
      empty: 'Rien n’est en file',
  ...
  status: {
    ...
    modelWeekLimit: (model) => `Limite hebdomadaire ${model}`,
